...
REDUCED_ACTIONS = tuple(REDUCED_ACTIONS_LIST)
TASK_ACTIONS = tuple(
    REDUCED_ACTIONS_LIST
    + [nethack.Command.APPLY, nethack.Command.DROP, nethack.Command.PICKUP, nethack.Command.PUTON,
       nethack.Command.QUAFF, nethack.Command.READ, nethack.Command.TAKEOFF, nethack.Command.THROW,
       nethack.Command.WEAR, nethack.Command.WIELD, nethack.Command.ZAP]
)
del REDUCED_ACTIONS_LIST
