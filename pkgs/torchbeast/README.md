...
This library is a fork of [torchbeast](https://github.com/facebookresearch/torchbeast), distributed in the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
This library is also be distributed under [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).

The changes are as follows:

- Added the last action to the return value.
    - [actorpool.cc](/libtorchbeast/actorpool.cc)
- Support for PolyBeast installation with [poetry](https://python-poetry.org).
